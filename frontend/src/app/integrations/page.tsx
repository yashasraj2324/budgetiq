      ...
      <div className="flex flex-col w-full gap-space-xl max-w-5xl mx-auto">
        ...
        <div className="bg-surface-container-lowest rounded-xl shadow-sm border border-outline-variant p-space-lg space-y-space-md">
          ...
          <div className="flex flex-wrap gap-2">
            <Link href="/onboarding/data" className="rounded bg-primary px-4 py-2 text-sm font-semibold text-on-primary">
              Go to CSV import
            </Link>
            <Link href="/settings" className="rounded border border-outline-variant px-4 py-2 text-sm hover:bg-surface-container-low">
