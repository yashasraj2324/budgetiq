        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-space-lg">
          ...
          <div className="bg-surface-container-lowest p-space-lg rounded shadow-sm flex flex-col justify-between">
            ...
            <div className="pt-space-sm flex items-center justify-between">
              ...
              <Link href="/recommendations" className="font-code-sm text-code-sm text-secondary font-medium hover:underline">Generate &rarr;</Link>
            </div>
          </div>
          ...
          <div className="bg-surface-container-lowest p-space-lg rounded shadow-sm flex flex-col justify-between">
            ...
            <div className="pt-space-sm flex items-center justify-between">
              <Link href="/approvals" className="font-code-sm text-code-sm text-primary-container font-medium hover:underline">Approve Batch &rarr;</Link>
              <Link href="/signals" className="font-code-sm text-code-sm text-secondary font-medium hover:underline">Signals &rarr;</Link>
            </div>
          </div>
                ...
                {all_budget_lines.map((line, i) => {
                  ...
                  <tr key={i} className="bg-surface-container-lowest hover:bg-surface-container-low transition-colors duration-100">
                    ...
                    <td className="py-3 px-space-lg text-right">
                      {hasAnomaly ? (
                        <Link href="/recommendations" className="inline-flex items-center gap-1 bg-primary-container hover:bg-primary text-on-primary px-3 py-1.5 rounded font-body-sm text-body-sm font-medium shadow-sm transition-colors duration-150">
                          <span>Resolve</span>
                        </Link>
                      ) : (
